...
- Approved production records: **3**
- Review targets: **8**
- Discovered candidates: **0**
- Approved for manual copy: **0**
- Pending discovery: **8**
...
|---|---|---|---|---|---|
| unDraw (`resource-73d75733406d`) | pending | unreviewed | — | — | Asset-library pilot target. Run the explicit discovery command before review. |
| Storyset (`resource-92baaed92865`) | pending | unreviewed | — | — | Asset-library pilot target. Run the explicit discovery command before review. |
| DrawKit (`resource-08a9f0e0bd50`) | pending | unreviewed | — | — | Asset-library pilot target. Run the explicit discovery command before review. |
