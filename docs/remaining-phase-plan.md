...
- reviewed media coverage is at 165 approved records, 27 pending resources,
  and 103 reviewed terminal outcomes;
...
The immediate next item is **5.4b-14**. It does not depend on authentication,
